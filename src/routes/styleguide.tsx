  ...
  return (
    <main className="mx-auto flex max-w-5xl flex-col gap-12 p-8">
      <header className="flex flex-col gap-2">
        <h1 className="text-4xl text-text-primary">social-ai Console — Styleguide</h1>
        <p className="text-text-secondary">
          Token parity check. Vietnamese sample: <span className="font-display">Trợ lý hỗ trợ khách hàng — Tổng quan</span>
        </p>
      </header>
